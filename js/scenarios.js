...
var SCENARIOS = [
    ...
    { id: 12, file: '12-takeoff-vs-land.html',           existing: 'Take-Off',      given: 'Land',          group: 'takeoff', ready: true },
    { id: 13, file: '13-land-vs-lineup.html',            existing: 'Land',          given: 'Line-Up',       group: 'land',    ready: true },
    { id: 14, file: '14-land-vs-cross.html',             existing: 'Land',          given: 'Cross/Enter',   group: 'land',    ready: true },
    { id: 15, file: '15-land-vs-takeoff.html',           existing: 'Land',          given: 'Take-Off',      group: 'land',    ready: true },
    { id: 16, file: '16-land-vs-land.html',              existing: 'Land',          given: 'Land',          group: 'land',    ready: true },
